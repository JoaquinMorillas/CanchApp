...
export const EditSportFieldPage = () => {
    ...
    useEffect(() => {
        const fetchSportField = async (id) =>{
            const response = await api.get(`/sport_field/${id}`)
            const gettedSportField = response.data

            const availabilitesResponse = await api.get(`/availability/sportField/${id}`)
        ...
        <div class="mb-3 d-flex align-items-center">
            {availabilites && availabilites.length > 0 ? (
                                    ...
                                    <td>
                                        {availability ? (
                                            ...
                                            <div className="d-flex justify-content-center gap-2">
                                                <NavLink to={`/administracion/canchas/editar/disponibilidad/${availability.id}`}>
                                            ...
                                            <NavLink to={`/administracion/canchas/editar/${id}/crear_disponibilidad/${day.key}`}>
                ...
                <>
                    ...
                    <br />
                    <NavLink to={`/administracion/canchas/editar/${id}/crear_disponibilidades`}>
