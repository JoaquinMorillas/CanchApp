...
export const SearchStablishmentsBySport = () => {
    ...
    useEffect(() => {
        setFilteredStablishments(stablishments.all.filter((st) => st.sports.some((sp) => sp.name == sport) && st.active == true))
  ...
  return (
    ...
    <div className="text-dark p-4 rounded" 
        style={{ backgroundColor: '#F8F9FA',  maxWidth: '1000px', margin: '0 auto' }}>
            <h3 className='text-center'>Establecimientos para jugar {sport.replace("_", " ")}:</h3>
