...
export const AddReservations = () => {
    ...
    const handleSubmitReservations = async () => {
        ...
        if(confirmed.isConfirmed){
            ...
            try{
                ...
                const response = await api.post(`/reservation/generate-slots?sportFieldId=${id}&startDate=${formattedBegining}&endDate=${formattedEnding}`)
    ...
    useEffect(() => {
        const fetchAvailabilities = async () => {
            ...
            const response = await api.get(`/availability/sportField/${id}`)
