...
export const SearcherComponent = () => {
  ...
  const {user} = useContext(AuthContext)
    ...
    useEffect(()=>{
        api .get("/address/cities").then((res)=> setCities(res.data));
  ...
  return (
    <>
      ...
      style={{ "backgroundColor" : "var(--bs-secondary)", color:"var(--bs-light)"}}>
        {user ? (
      <h4 className='mb-3'>¡Hola {user.firstName.toUpperCase()}! ¿A que vas a jugar hoy?</h4>
        ): ( 
        ...
        <div className="row g-3 align-items-end">
          ...
          <div className="col-12 text-center mt-3"> 
            <button className='btn w-30 w-lg-auto btn-lg'
